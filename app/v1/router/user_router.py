from fastapi import APIRouter  #permite crear la ruta en cualquier parte del proyecto
from fastapi import Depends
from fastapi import status
from fastapi import Body  #permite que lo que viaje por http lo haga a traves del cuerpo
